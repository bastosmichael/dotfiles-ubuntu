...
then
	...
	sudo apt-get install -y build-essential screen git-core curl openssh-client openssh-server libxslt-dev libxml2-dev libqt4-dev qtcreator nmap winusb pcscd coolkey meld nautilus-dropbox imagemagick
